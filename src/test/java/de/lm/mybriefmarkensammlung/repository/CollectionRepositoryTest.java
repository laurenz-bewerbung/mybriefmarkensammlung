...
class CollectionRepositoryTest extends AbstractPostgresTest {
    ...
    @Test
    @DisplayName("Should find nothing by exhibition class")
    void testFindNothingByExhibitionClass() {
        // Arrange
        Collection col1 = collectionRepository.save(new Collection("test", cat1Id, "", new HashSet<>(), true, "Class1", user1Id));
        Collection col2 = collectionRepository.save(new Collection("test", cat1Id, "", new HashSet<>(), true, "Class1", user1Id));

        // Act
        List<Collection> collections = collectionRepository.search("", null, true, "Class2", null);
    ...
    @Test
    @DisplayName("Should find nothing by user")
    void testFindNothingByUser() {
        // Arrange
        Collection col1 = collectionRepository.save(new Collection("test", cat1Id, "", new HashSet<>(), false, null, user1Id));
        Collection col2 = collectionRepository.save(new Collection("test", cat1Id, "", new HashSet<>(), false, null, user1Id));

        // Act
        List<Collection> collections = collectionRepository.search("", null, null, null, user2Id);
